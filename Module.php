 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'purocean\yii2admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@purocean/yii2admin/views/layouts/main.php';
    /**
     * @var array
     * @see [[menus]]
     */
    ...
    public function init()
    {
        ...
        if (!isset(Yii::$app->i18n->translations['rbac-admin'])) {
            Yii::$app->i18n->translations['rbac-admin'] = [
                ...
                'sourceLanguage' => 'en',
                'basePath' => '@purocean/yii2admin/messages'
            ];
        }
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('purocean\yii2admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
