...
namespace purocean\yii2admin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use purocean\yii2admin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\purocean\yii2admin\models\Menu]].
 *
